...
if (!function_exists('modfarm_render_taxonomy_grid_block')) {
  function modfarm_render_taxonomy_grid_block($attributes, $content = '', $block = null) {
    ...
    $text_color = sanitize_hex_color((string)$a['textColor']);
    $wrapper_style_attr = $text_color ? ' style="--mfb-taxgrid-text:' . esc_attr($text_color) . ';"' : '';
    ...
    if ('series_by_genre' === $group_mode) {
      ...
      ob_start(); ?>
      <div class="mfb-taxgrid-wrapper mfb-taxgrid-wrapper--grouped<?php echo ' mfb-shape--'.esc_attr($shape); ?>"<?php echo $anchor; ?><?php echo $wrapper_style_attr; ?>>
    ...
    if ('books_by_series' === $group_mode) {
      ...
      ob_start(); ?>
      <div class="mfb-wrapper mfb-taxgrid-wrapper mfb-taxgrid-wrapper--series-books<?php echo ' mfb-shape--'.esc_attr($shape); ?>"<?php echo $anchor; ?><?php echo $wrapper_style_attr; ?>>
        <?php if (!empty($a['showTOC'])) $render_section_toc($toc_items); ?>
    ...
    ob_start(); ?>
    <div class="mfb-taxgrid-wrapper<?php echo ' mfb-shape--'.esc_attr($shape); ?>"<?php echo $anchor; ?><?php echo $wrapper_style_attr; ?>>
