...
(function (wp) {
  ...
  // Canonical option lists (shared with other card blocks)
  const CTA_OPTIONS = [
  ...
  registerBlockType('modfarm/archive-book-list', {
    apiVersion: 2,
    title: 'Book Archive List',
    icon: 'book',
    category: 'widgets',
    ...
    edit: function (props) {
      ...
      // Format terms for optional archive filter (parity w/ other blocks)
      ...
      // Helpers for color overrides (same as multi-tax)
      ...
      return el(
        ...
        el(InspectorControls, {},
          ...
          el(PanelBody, { title: __('Card Layout & Styles', 'modfarm'), initialOpen: false },
            ...
            cardUseGlobal
              ? el('p', { className: 'components-base-control__help' },
                  __('Using global shapes, spacing, and shadows from ModFarm Settings. Turn this off to override styles for this archive only.', 'modfarm')
                )
              : el(Fragment, {},
                  el(SelectControl, {
                  ...
                  el('p', { className: 'components-base-control__label' },
                    __('Per-Archive Colors (optional)', 'modfarm')
                  ),
          ...
          el(PanelBody, { title: __('Display Toggles', 'modfarm'), initialOpen: false },
            cardUseGlobal
              ? el('p', { className: 'components-base-control__help' },
                  __('Visibility is using the global Book Card settings. Turn off "Use Global Card Styles" to override for this archive.', 'modfarm')
                )
              : el(Fragment, {},
                  el(ToggleControl, {
            ...
            // Audio Mode applies regardless of global/local styles
            el(SelectControl, {
