<?php
/**
 * Pattern: Latest Releases Left
 * Category: modfarm-page-elements
 */
return array(
  'title'      => 'Latest Releases Left',
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-right:0;padding-bottom:var(--wp--preset--spacing--50);padding-left:0"><!-- wp:heading {"textAlign":"left"} -->
