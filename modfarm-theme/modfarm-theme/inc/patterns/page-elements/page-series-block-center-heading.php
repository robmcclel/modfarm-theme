<?php
return [
    'slug'        => 'modfarm/page-series-block-center-heading',
    'title'       => 'Page Series Block Center Heading',
    'description' => '',
...
<h2 class="wp-block-heading has-text-align-center has-xlarge-font-size">Series Title</h2>
<!-- /wp:heading -->
