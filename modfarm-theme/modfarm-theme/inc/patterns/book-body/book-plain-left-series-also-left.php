<?php
/**
 * Pattern: Book Plain Left Series Also Left
 * Slug: modfarm/book-plain-left-series-also-left
 */

return [
  'slug'       => 'modfarm/book-plain-left-series-also-left',
  'title'      => 'Book Plain Left Series Also Left',
  'categories' => [ 'modfarm-book-body' ],
  'content'    => <<<'HTML'
<!-- wp:group {"metadata":{"patternName":"core/block/633","name":"Book Standard Left Series Also Left"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|20","right":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--20)"><!-- wp:group {"metadata":{"categories":["modfarm-book-elements"],"patternName":"modfarm/book-info-plain-left","name":"Book Info Plain Left"},"style":{"spacing":{"padding":{"bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
