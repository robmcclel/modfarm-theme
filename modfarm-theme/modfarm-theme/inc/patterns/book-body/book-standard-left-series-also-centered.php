<?php
/**
 * Pattern: Book Standard Left Series Also Centered
 * Slug: modfarm/book-standard-left-series-also-centered
 */

return [
  'slug'       => 'modfarm/book-standard-left-series-also-centered',
  'title'      => 'Book Standard Left Series Also Centered',
  'categories' => [ 'modfarm-book-body' ],
  'content'    => <<<'HTML'
<!-- wp:group {"metadata":{"patternName":"core/block/630","name":"Book Standard Right Series Also Centered"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|20","right":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
