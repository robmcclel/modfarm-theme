<?php
/**
 * Pattern: Book Plain Left Series Centered
 * Slug: modfarm/book-plain-left-series-centered
 */

return [
  'slug'       => 'modfarm/book-plain-left-series-centered',
  'title'      => 'Book Plain Left Series Centered',
  'categories' => [ 'modfarm-book-body' ],
  'content'    => <<<'HTML'
<!-- wp:group {"metadata":{"patternName":"core/block/618","name":"Book Plain Centered"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|20","right":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
