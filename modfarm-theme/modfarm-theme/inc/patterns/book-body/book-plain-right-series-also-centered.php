<?php
/**
 * Pattern: Book Plain Right Series Also Centered
 * Slug: modfarm/book-plain-right-series-also-centered
 */

return [
  'slug'       => 'modfarm/book-plain-right-series-also-centered',
  'title'      => 'Book Plain Right Series Also Centered',
  'categories' => [ 'modfarm-book-body' ],
  'content'    => <<<'HTML'
<!-- wp:group {"metadata":{"patternName":"core/block/623","name":"Book Plain Series Also Center Heading"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|20","right":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
