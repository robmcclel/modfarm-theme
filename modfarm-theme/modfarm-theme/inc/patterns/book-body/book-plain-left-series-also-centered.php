<?php
/**
 * Pattern: Book Plain Left Series Also Centered
 * Slug: modfarm/book-plain-left-series-also-centered
 */

return [
  'slug'       => 'modfarm/book-plain-left-series-also-centered',
  'title'      => 'Book Plain Left Series Also Centered',
  'categories' => [ 'modfarm-book-body' ],
  'content'    => <<<'HTML'
<!-- wp:group {"metadata":{"patternName":"core/block/619","name":"Book Plain Left Centered"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|20","right":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
