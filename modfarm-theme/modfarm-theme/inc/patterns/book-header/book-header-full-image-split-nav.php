<?php
return [
    'slug'        => 'modfarm/book-header-full-image-split-nav',
    'title'       => 'Book Header Full Image Split Nav',
    'description' => '',
