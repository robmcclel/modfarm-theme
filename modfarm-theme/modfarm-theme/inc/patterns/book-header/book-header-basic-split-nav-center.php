<?php
return [
    'slug'        => 'modfarm/book-header-basic-split-nav-center',
    'title'       => 'Book Header Basic Split Nav Center',
    'description' => '',
    'categories'  => [ 'modfarm-book-header' ],
    'keywords'    => [],
    'content'     => '
<!-- wp:group {"align":"full","layout":{"type":"default"}} -->
<div class="wp-block-group alignfull"><!-- wp:modfarm/navigation-menu {"layoutType":"split","leftMenu":7,"rightMenu":8,"centerContent":"site-logo","align":"full"} /-->
