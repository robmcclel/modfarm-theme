<?php
return [
    'slug'        => 'modfarm/book-header-deluxe-full-image-and-cover',
    'title'       => 'Book Header Deluxe Full Image and Cover',
    'description' => '',
    'categories'  => [ 'modfarm-book-header' ],
    'keywords'    => [],
    'content'     => '
<!-- wp:group {"metadata":{"name":"Book Header Deluxe Full Image with Cover"},"align":"full","layout":{"type":"constrained"}} -->
...
<!-- wp:columns {"verticalAlignment":null,"style":{"spacing":{"padding":{"right":"var:preset|spacing|50","left":"var:preset|spacing|50"}}}} -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:66.66%"><!-- wp:modfarm/format-icons {"align":"center"} /-->
